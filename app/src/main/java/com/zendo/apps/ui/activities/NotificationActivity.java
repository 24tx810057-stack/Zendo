...
import com.zendo.apps.ui.adapters.NotificationAdapter;

import com.zendo.apps.data.models.Notification;
...
public class NotificationActivity extends AppCompatActivity {
    ...
    private void loadNotifications() {
        if (userEmail == null || userEmail.isEmpty()) {
            Log.e("NotificationActivity", "User email is empty, cannot load notifications");
            updateUI();
            return;
        }
        ...
        db.collection("notifications")
                ...
                .addSnapshotListener((value, error) -> {
                    if (error != null) {
                        Log.e("NotificationActivity", "Error loading notifications: " + error.getMessage());
                        return;
                    }
                    if (value != null) {
                        ...
                        // Sort locally to handle mixed timestamp types gracefully
