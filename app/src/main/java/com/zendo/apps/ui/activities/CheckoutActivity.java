...
public class CheckoutActivity extends AppCompatActivity {
    ...
    private void calculateTotals() {
        ...
        if (shippingFee == 0) {
            ...
            binding.tvFastPrice.setBackgroundResource(R.drawable.bg_free_tag);
            binding.tvFastPrice.setPadding(16, 4, 16, 4);
            ...
            binding.tvStandardPrice.setBackgroundResource(R.drawable.bg_free_tag);
            binding.tvStandardPrice.setPadding(16, 4, 16, 4);
            ...
            binding.tvFastPrice.setBackgroundResource(0);
            ...
            binding.tvStandardPrice.setBackgroundResource(0);
